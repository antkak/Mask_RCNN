...
def demo_mot(input_dir, pickle_dir ,use_extra_boxes=False):
	...
	# app2_list = [np.linalg.svd(app2[0,i,:,:,:], full_matrices=False, compute_uv=False).flatten('F') for i in range(app2.shape[1])]
...
if __name__ == '__main__':
	...
	pickle_dir = '/home/anthony/maskrcnn/Mask_RCNN/samples/pickles/0003s'
	st_mot = datetime.now()
